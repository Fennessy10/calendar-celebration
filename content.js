...
// CHANGED! - Added more color gradients for higher levels
const colorTiers = [
  ...
  'linear-gradient(90deg, #bdc3c7, #e0e0e0)', // Levels 80-89 (Silver) - NEW!
  'linear-gradient(90deg, #00A896, #02C39A)', // Levels 90-99 (Teal) - NEW!
  'linear-gradient(90deg, #d63384, #ff69b4)', // Levels 100-109 (Magenta) - NEW!
  'linear-gradient(90deg, #483D8B, #6A5ACD)', // Levels 110-119 (Cosmic Blue) - NEW!
  'linear-gradient(90deg, #FF4E50, #F9D423)', // Levels 120-129 (Sunset Fire) - NEW!
  'linear-gradient(90deg, #00c6ff, #0072ff)', // Levels 130+ (Deep Sky) - NEW!
];
...
function updateUI(level, xp, xpForNextLevel) {
  ...
  // Use the modulo operator to cycle through the color array if the level exceeds the number of defined colors
